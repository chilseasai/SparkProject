...
public class ESVDataGenerator {
    ...
    private static void addESVColumn(String inputPath, String outputPath) {
        ...
        Dataset<ESVDataType> esv = esvCandidate.withColumn("esv", functions.lit(1).cast(DataTypes.IntegerType))
...
//        String outputPath = "/Users/jcsai/Downloads/My Project/indexation_data_generator/esv_candidate_2_esv/esv-data-random";
